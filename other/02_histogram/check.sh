...
if [ -d "/mnt/raid6/bacphagenetwork/data/07_histogram" ]
then
    ...
    then
        ...
        mv /mnt/raid6/bacphagenetwork/data/07_histogram /mnt/raid6/bacphagenetwork/data/07_histogram_bak_$(date +%Y%m%d%H%M%S)
    else
        echo "The original output folder will be removed."
        rm -rf /mnt/raid6/bacphagenetwork/data/07_histogram
    fi
fi

mkdir /mnt/raid6/bacphagenetwork/data/07_histogram
mkdir /mnt/raid6/bacphagenetwork/data/07_histogram/Beijing
mkdir /mnt/raid6/bacphagenetwork/data/07_histogram/Guangzhou
