...
if [ -d "/mnt/raid6/bacphagenetwork/data/08_analysis" ]
then
    ...
    then
        ...
        mv /mnt/raid6/bacphagenetwork/data/08_analysis /mnt/raid6/bacphagenetwork/data/08_analysis_bak_$(date +%Y%m%d%H%M%S)
    else
        echo "The original output folder will be removed."
        rm -rf /mnt/raid6/bacphagenetwork/data/08_analysis
    fi
fi

mkdir /mnt/raid6/bacphagenetwork/data/08_analysis
mkdir /mnt/raid6/bacphagenetwork/data/08_analysis/Beijing
mkdir /mnt/raid6/bacphagenetwork/data/08_analysis/Guangzhou
