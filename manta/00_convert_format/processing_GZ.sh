...
#SBATCH --mem=1G
#SBATCH --export=INPUT_PATH='/mnt/raid6/bacphagenetwork/data/06_unmapped_removed/Guangzhou',OUTPUT_PATH='/mnt/raid6/bacphagenetwork/data/07_manta/00_format_converted/Guangzhou'
