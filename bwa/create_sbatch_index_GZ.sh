...
read genome_path
# The path of the genome data is '/mnt/raid6/bacphagenetwork/data/skin_metagenome/Guangzhou/02_rm_host'
export GENOME_PATH=$genome_path
echo "The path to the genome data has been set to $GENOME_PATH."

# Check whether the index exists
if [ ! -f "./slurm/gz_sbatch.list" ]
then
...
do
    ...
    echo "$file_fq1" >> ./slurm/gz_sbatch.list
