...
CONVERTED_DATA_PATH="$OUTPUT_BASE_PATH/04_convert/Beijing"
ADDED_TAG_DATA_PATH="$OUTPUT_BASE_PATH/03_tag_added/Beijing"
...
samtools addreplacerg -r 'ID:${sample_name}' -r 'SM=${sample_name}' -r 'PL:illumina' -r 'CN:BJ' $CONVERTED_DATA_PATH/${sample_name}.sam > $ADDED_TAG_DATA_PATH/${sample_name}.bam \
