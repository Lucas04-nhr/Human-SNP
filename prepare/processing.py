# Draw a histogram of all flags in the SAM file
# Test command
# python processing.py -i /mnt/raid6/bacphagenetwork/data/04_convert/Beijing/BJ001.sam -o /mnt/raid6/bacphagenetwork/data/05_process/Beijing -s /mnt/raid6/bacphagenetwork/data/05_process/Beijing/static
