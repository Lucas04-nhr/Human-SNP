...
read genome_path
# The path of the pre-processed *.bam data is '/mnt/raid6/bacphagenetwork/data/samtools_analysis/Beijing'
export GENOME_PATH=$genome_path
echo "The path to the genome data has been set to $GENOME_PATH."

# Check whether the index exists
if [ ! -f "./bj_02_sbatch.list" ]
then
    echo "The index does not exist, creating it ..."
    touch ./bj_02_sbatch.list
else
...
do
    echo "$GENOME_PATH/$file_fq1" >> ./bj_02_sbatch.list
