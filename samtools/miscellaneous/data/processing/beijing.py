...
# Read the data
data_bj = pd.read_csv('D:/pythonCODE/envTest/Beijing.txt', sep='\t')
...
#plt.savefig('D:/pythonCODE/envTest/Beijing.png')
#plt.show()
...
# Plot the ratio
plt.figure(figsize=(10, 6), dpi=300)
#plt.plot(data_bj_converted['Ratio1'], label='Paired in sequencing/Mapped ratio')
...
plt.savefig('D:/pythonCODE/envTest/Beijing_ratio.png')
plt.show()
