...
echo "Please enter the path to the marked *.bam data of Guangzhou:"
read genome_path
# The path of the marked *.bam data is '/mnt/raid6/bacphagenetwork/data/04_dulplicate_marked/Guangzhou'
...
for file_fq1 in $(ls ${GENOME_PATH} | grep -E '.marked.bam')
do
