...
if [ -d "/mnt/raid6/bacphagenetwork/data/05_samtools_marked" ]
then
    ...
    then
        ...
        mv /mnt/raid6/bacphagenetwork/data/05_samtools_marked /mnt/raid6/bacphagenetwork/data/05_samtools_marked_bak_$(date +%Y%m%d%H%M%S)
    else
        echo "The original output folder will be removed."
        rm -rf /mnt/raid6/bacphagenetwork/data/05_samtools_marked
    fi
fi

mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked
mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked/Beijing
mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked/Guangzhou
...
if [ -d "/mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats" ]
then
    ...
    then
        ...
        mv /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats_bak_$(date +%Y%m%d%H%M%S)
    else
        echo "The original stats folder will be removed."
        rm -rf /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats
    fi
fi

mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats
mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats/Beijing
mkdir /mnt/raid6/bacphagenetwork/data/05_samtools_marked_stats/Guangzhou
