...
echo "Please enter the path to the sorted *.bam data of Guangzhou:"
read genome_path
# The path of the sorted *.bam data is '/mnt/raid6/bacphagenetwork/data/03_samtools_sorted/Guangzhou'
...
for file_fq1 in $(ls ${GENOME_PATH} | grep -E '.sorted.bam')
do
