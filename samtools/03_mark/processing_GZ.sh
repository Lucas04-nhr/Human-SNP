...
#SBATCH --output=./log/Guangzhou/mark_dulplicate_GZ_%j.out
#SBATCH --error=./log/Guangzhou/mark_dulplicate_GZ_%j.err
#SBATCH --cpus-per-task=4
#SBATCH --mem=1G
#SBATCH --export=INPUT_PATH='/mnt/raid6/bacphagenetwork/data/03_samtools_sorted/Guangzhou',OUTPUT_PATH='/mnt/raid6/bacphagenetwork/data/04_dulplicate_marked/Guangzhou',JAVA_BIN='/mnt/raid6/bacphagenetwork/tools/jdk-22.0.1/bin/java',PICARD_BIN='/mnt/raid6/bacphagenetwork/tools/picard_pre-built/v3.0/picard.jar',PICARD_OLD_BIN='/mnt/raid6/bacphagenetwork/tools/picard_pre-built/v2.26.0/picard.jar'
