...
echo "Please enter the path to the sorted *.bam data of Beijing:"
read genome_path
# The path of the sorted *.bam data is '/mnt/raid6/bacphagenetwork/data/03_samtools_sorted/Beijing'
