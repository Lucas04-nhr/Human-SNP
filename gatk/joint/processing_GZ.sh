#! /bin/bash
#SBATCH --job-name=joint_GZ
#SBATCH --output=./log_GZ.%j.out
#SBATCH --error=./log_GZ.%j.err
...
export GENOTYPE_GVCF_PATH="$BASE_PATH/08_GenotypeGVCF/Guangzhou"
export VARIANTRECALIBRATOR_DATA_PATH="$BASE_PATH/09_VariantRecalibrator/Guangzhou"
export APPLYVQSR_DATA_PATH="$BASE_PATH/10_ApplyVQSR/Guangzhou"
